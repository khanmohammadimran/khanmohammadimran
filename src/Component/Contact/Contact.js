                ...
                <div className="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
                    ...
                    <div>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mt-8">
                                <input type="submit" value="Submit" className="uppercase text-sm tracking-wide bg-primary text-white p-3 rounded-lg w-full focus:outline-none focus:shadow-outline" />
                            </div>
                        </form>
                    </div>
                </div>
