...
const MyPortfolio = () => {
    return (
        <div id='myportfolio' class="hero min-h-screen">
            <div class="hero-content flex-col lg:flex-row-reverse">
                <img src={imran} class="w-1/2 max-w-sm rounded-lg shadow-2xl" alt='' />
                <div className="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <p className="pt-8 text-sm font-nunito"> <strong>Expertise:</strong> JavaScript, ES6, React, React Router, React Hook, Firebase (Authentication), HTML5,
