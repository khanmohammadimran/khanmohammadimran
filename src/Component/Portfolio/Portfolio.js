...
const MyPortfolio = () => {
    return (
        <div id='myportfolio' className="hero min-h-screen font-nunito">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src={imran} className="w-1/2 max-w-sm rounded-lg shadow-2xl" alt='' />
                <div className="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <p className="pt-8 text-sm"> <strong>Expertise:</strong> JavaScript, ES6, React, React Router, React Hook, Firebase (Authentication), HTML5,
