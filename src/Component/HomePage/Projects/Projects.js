            ...
            <div className='grid lg:grid-cols-3 gap-2 justify-items-center font-nunito bg-neutral py-8'>
                <div className="card bg-white shadow-xl lg:w-96 sm:auto-cols-auto">
                    <figure className="px-10 pt-10">
                        <img src={picassoPainting} alt="Shoes" className="rounded-xl" />
                    </figure>
                ...
                <div className="card bg-white shadow-xl lg:w-96 sm:auto-cols-auto">
                    <figure className="px-10 pt-10">
                        <img src={huntingHiking} alt="Shoes" className="rounded-xl" />
                    </figure>
                    <div className="card-body items-center">
                        ...
                        <div className="card-actions justify-end">
                            <button className="btn btn-primary text-white">See Full Detail</button>
                ...
                <div className="card bg-white shadow-xl lg:w-96 sm:auto-cols-auto">
                    <figure className="px-10 pt-10">
                        <img src={tempestTravel} alt="Shoes" className="rounded-xl" />
                    </figure>
                    <div className="card-body items-center">
